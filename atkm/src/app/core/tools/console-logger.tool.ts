...
export class ConsoleLogger {
  ...
  private getPalette(name: ConsoleLoggerOptions['palette']) {
    ...
    const named: Record<string, typeof base> = {
      ...
      in: { ...base, title: this.hex('#ebebebff'), key: this.hex('#64b1fe'), tag: this.hex('#1E90FF'), value: this.hex('#1E90FF'), meta: this.hex('#abababff') },
      ...
      st: { ...base, title: this.hex('#FFFF30'), key: this.hex('#abababff'), tag: this.hex('#FFFF30'), value: this.hex('#abababff'), meta: this.hex('#abababff') },
      ss: { ...base, title: this.hex('#FFFF30'), key: this.hex('#abababff'), tag: this.hex('#FFFF30'), value: this.hex('#2cf72c'), meta: this.hex('#abababff') },
      se: { ...base, title: this.hex('#FFFF30'), key: this.hex('#abababff'), tag: this.hex('#E81123'), value: this.hex('#E81123'), meta: this.hex('#abababff') },

      ht: { ...base, title: this.hex('#39FF14'), key: this.hex('#abababff'), tag: this.hex('#39FF14'), value: this.hex('#abababff'), meta: this.hex('#abababff') },
      hs: { ...base, title: this.hex('#39FF14'), key: this.hex('#abababff'), tag: this.hex('#39FF14'), value: this.hex('#2cf72c'), meta: this.hex('#abababff') },
      he: { ...base, title: this.hex('#39FF14'), key: this.hex('#abababff'), tag: this.hex('#E81123'), value: this.hex('#E81123'), meta: this.hex('#abababff') },
      ...
      aapi: { ...base, title: this.hex('#00FFFF'), key: this.hex('#abababff'), tag: this.hex('#00FFFF'), value: this.hex('#abababff'), meta: this.hex('#abababff') },
      aapis: { ...base, title: this.hex('#00FFFF'), key: this.hex('#abababff'), tag: this.hex('#00FFFF'), value: this.hex('#2cf72c'), meta: this.hex('#abababff') },
      aapie: { ...base, title: this.hex('#00FFFF'), key: this.hex('#abababff'), tag: this.hex('#E81123'), value: this.hex('#E81123'), meta: this.hex('#abababff') },
